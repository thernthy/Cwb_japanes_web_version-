...
<div class="row tm-services-row detail">
	<div class="col-xs-12 text-tengah">
		<h1>Privacy Policy of CWB</h1>

		<p>CWB operates the cwb-team.net website, which provides the SERVICE.</p>

		<p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
			of Personal Information if anyone decided to use our Service, the cwb new world website.</p>
		...
		<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
			accessible at cwb-team.net, unless otherwise defined in this Privacy Policy.</p>
